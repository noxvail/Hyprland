...
std::string CHyprCtl::getWindowData(PHLWINDOW w, eHyprCtlOutputFormat format) {
    ...
    "xdgDescription": "{}"
            ...
            (g_pInputManager->isWindowInhibiting(w, false) ? "true" : "false"),  NContentType::toString(CONTENT_TYPE), escapeJSONStrings(w->xdgTag().value_or("")), escapeJSONStrings(w->xdgDescription().value_or("")));
    } else {
        return std::format(
            "Window {:x} -> {}:\n\tmapped: {}\n\thidden: {}\n\tat: {},{}\n\tsize: {},{}\n\tworkspace: {} ({})\n\tfloating: {}\n\tpseudo: {}\n\tmonitor: {}\n\tclass: {}\n\ttitle: "
            "{}\n\tinitialClass: {}\n\tinitialTitle: {}\n\tpid: "
            ...
            NContentType::toString(CONTENT_TYPE), w->xdgTag().value_or(""), w->xdgDescription().value_or(""));
    }
}
